package com.pinyin.ui.mainnavigatetabbar.widget;
...
import com.pinyin.ui.mainnavigatetabbar.ThemeUtils;
...
public class MainNavigateTabBar extends LinearLayout implements View.OnClickListener {
    ...
    public MainNavigateTabBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mNormalTextColor = (tabTextColor != null ? tabTextColor : context.getResources().getColorStateList(R.color.colorBlack));
...
//        }
        ...
        if (tabParam.iconResId > 0 && tabParam.iconSelectedResId > 0) {
            view.setTag(holder);
            if(tabParam.iconResId != R.mipmap.ic_blank&&tabParam.iconSelectedResId !=R.mipmap.ic_blank)
